    ...
    return(
        <div className="container">
                    ...
                    <div className="form-group mb-4" style={{textAlign: "left"}}>
                        ...
                        <input id="93094cda-f22d-11ed-a05b-0242ac120003" className="form-control" type="text" placeholder="Enter finance name" onChange={(e) => {setName(e.target.value)}}/>
                    </div>
                    <div className="form-group mb-4" style={{textAlign: "left"}}>
                        <label>Last change</label>
                        <input id="93094f32-f22d-11ed-a05b-0242ac120003" className="form-control" type="date" placeholder="Enter date of the last change" onChange={(e) => {setChange(e.target.value)}}/>
                    </div>
                    <div className="form-group mb-4" style={{textAlign: "left"}}>
                        <label>Amount</label>
                        <input id="93095072-f22d-11ed-a05b-0242ac120003" className="form-control" type="number" placeholder="Enter amount" onChange={(e) => {setAmount(e.target.value)}}/>
                    </div>
                    <div className="form-group mb-4" style={{textAlign: "left"}}>
                        <label>Type of finance</label>
                        <input id="9309553ba-f22d-11ed-a05b-0242ac120003" className="form-control" type="text" placeholder="Enter type of finance" onChange={(e) => {setType(e.target.value)}}/>
                    </div>
